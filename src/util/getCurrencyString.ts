export default function getCurrencyString(
    ...
    return `${mainSymbolLocation === "front" ? symbol : ""}${fullPartSplit}${hasDecimals ? decimalSymbol : ""}${hasDecimals ? decimalsPart : ""}${mainSymbolLocation === "back" ? symbol : ""}`
}